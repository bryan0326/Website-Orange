...
--><html><head><title>意見回饋</title>
    <link rel="icon" type="image/png" href="images/orange.png"><meta http-equiv="content-type" content="text/html; charset=utf-8"><meta name="description" content=""><meta name="keywords" content=""><meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1"><!--[if lte IE 8]><script src="js/html5shiv.js"></script><![endif]--><script src="js/jquery.min.js"></script><script src="js/skel.min.js"></script><script src="js/skel-layers.min.js"></script><script src="js/init.js"></script><noscript>
			...
			<style>
				...
				.faq-item.active p {
					display: block; /* Show the answer when the FAQ item is active */
				}
				.faq-item h3 {
					position: relative;
				}
		...
		<!-- Header -->
			<header id="header" class="skel-layers-fixed">
                ...
                <nav id="nav">
                    <ul>
                ...
                </nav></header><!-- Main --><section id="main" class="wrapper style1"><header class="major"></header>
						<section id="faq" class="wrapper style1">
							...
							<div class="faq-container">
								...
								<div class="faq-item">
									...
									<p>若您上傳的課程評價/考古題狀態為「未通過」即可修改並重新提交審核，但不能刪除；若「已通過」則無法再修改或刪除。（2023.08.03 更新：為避免發生同學修改了正在審查的課程評價，因此若為「待審核」狀態則無法修改與刪除。）</p>
								</div>
								<div class="faq-item">
								...
								<div class="faq-item">
									...
									<p>請您先重新整理頁面或使用 shift + F5，若仍無法排除您的問題，請與我們聯繫 orange66367749@gmail.com，或至 Instagram：bo_sung_92(鹿寮里里長伯) 搭配「截圖」與我們詳述您遇到的問題，我們會儘速修復與改善，謝謝您！</p>
								</div>
								<div class="faq-item">
						...
						<form id="feedbackForm">
							...
							<button type="button" onclick="submitFeedback()" style="background-color: #333; color: #fff; padding: 12px 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;"
    						onmouseover="this.style.backgroundColor='#707070'" onmouseout="this.style.backgroundColor='#333'">提交回饋</button>
						</form></section>
						<script>
						...
						</script></section><!-- Footer --><footer id="footer">
    <ul class="icons">
